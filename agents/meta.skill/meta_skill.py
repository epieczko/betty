...
'''
    ...
    def generate_readme(self, skill_desc: Dict[str, Any]) -> str:
        """
        Generate README.md
...
'''
    ...
    def create_skill(
        ...
        readme_content = self.generate_readme(skill_desc)
...
def main():
    ...
    try:
        result = creator.create_skill(args.description, output_dir=args.output)
